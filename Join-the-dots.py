...
def hero_page():
    ...
    while hero:
        ...
        start_btn_rect = pygame.draw.rect(screen,(255,255,255),(width/4,height/2,120,60),10,20)
        up_btn_rect = pygame.draw.rect(screen,(255,255,255),(width/2+40,height/2-45,50,50),7,5)
        down_btn_rect = pygame.draw.rect(screen,(255,255,255),(width/2+40,height/2+45,50,50),7,5)
